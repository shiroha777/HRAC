...
Ablation studies isolate the contribution of key components (global median cap, history-residual clipping, and $\nu$-based weighting). Success is defined as: (i) minimal degradation under benign training relative to FedAvg, (ii) clear accuracy/stability improvements under attacks, and (iii) avoidance of overly aggressive suppression under non-IID settings.
